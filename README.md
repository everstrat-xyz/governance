...
| [014](014-strategy-manager-performance-fee-bps/) | StrategyManager: turn the performance fee on — `setPerformanceFeeBps(1000)` (0 → 10%) | 🟡 **Prepared** — payloads built + fork-verified (schedule gas 56,071 / execute 75,111); SafeTx signed by delegate `0x1483E048…0e922` (`safeTxHash = 0x201f9ad4…cdf4452`) but **not submitted** — Safe Tx Service returned `429 Monthly quota exceeded` (reset ~2026-10-01). Submit from the Safe UI; **confirm the 1000 bps rate first** (retroactive to all accrued unharvested LP fees, audit M15) | `0xdca0bcc4…b409b45` |
