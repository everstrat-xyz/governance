...
| [016](016-strategy-keeper-exit-settlement-funding/) | **Draft** — not yet submitted to the Safe |
...
**016 is a draft for keeper exit funding.** It lowers the StrategyKeeperExecutor's `minWithdrawETH`
...
| [016](016-strategy-keeper-exit-settlement-funding/) | StrategyKeeperExecutor: `setMinWithdrawETH(1e14)` (0.01 → 0.0001 ETH) + `setControllerReserveETH(5e16)` (0 → 0.05 ETH) (batch) | **Draft** — 2026-09-23, not yet submitted | `0xc9c3bc84…5e5f5725` (min withdraw), `0x826b1bdb…566a02d5` (reserve) |
