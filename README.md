...
| [014](014-strategy-manager-performance-fee-bps/) | StrategyManager: turn the performance fee on — `setPerformanceFeeBps(1500)` (0 → **15%**, rate set by Arseny 2026-09-21) | 🟡 **Prepared** — payloads built + fork-verified (schedule gas 56,071 / execute 75,111; `performanceFeeBps` 0 → 1500); SafeTx signed by delegate `0x1483E048…0e922` (`safeTxHash = 0x201f9ad4…cdf4452`) but **not submitted** — Safe Tx Service returned `429 Monthly quota exceeded` (reset ~2026-10-01). Submit from the Safe UI (quota is per IP) | `0xc4302e52…f74ea46` |
